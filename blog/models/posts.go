...
type Post struct {
	...
	Short null.String `boil:"short" json:"short,omitempty" toml:"short" yaml:"short,omitempty"`
...
var PostWhere = struct {
	...
	Short whereHelpernull_String
	Body  whereHelpernull_String
}{
	ID:    whereHelperuint{field: "`posts`.`id`"},
	Title: whereHelpernull_String{field: "`posts`.`title`"},
	Short: whereHelpernull_String{field: "`posts`.`short`"},
	Body:  whereHelpernull_String{field: "`posts`.`body`"},
}
...
var (
	postAllColumns            = []string{"id", "title", "short", "body"}
	postColumnsWithoutDefault = []string{"title", "short", "body"}
