...
type Blog struct {
	...
	Contents string `boil:"Contents" json:"Contents" toml:"Contents" yaml:"Contents"`
...
var BlogWhere = struct {
	...
	Contents whereHelperstring
}{
	ID:       whereHelperint{field: "`blogs`.`ID`"},
	Title:    whereHelperstring{field: "`blogs`.`Title`"},
	Contents: whereHelperstring{field: "`blogs`.`Contents`"},
}
...
var (
	blogAllColumns            = []string{"ID", "Title", "Contents"}
	blogColumnsWithoutDefault = []string{"ID", "Title", "Contents"}
